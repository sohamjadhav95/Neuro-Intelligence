...
# Increase Volume
    def increase_volume(self):
        try:
            ...
            speak_text(f"Error adjusting volume: {e}")
    ...
    def mute_sound(self):
        try:
            ...
            speak_text(f"Error muting sound: {e}")
    ...
    def unmute_sound(self):
        try:
            ...
            speak_text(f"Error unmuting sound: {e}")
    ...
    def sleep_mode(self):
        try:
            ...
            speak_text(f"Error putting system to sleep: {e}")
        ...
        if confirmation is not None:
            if "yes" in confirmation:
                ...
                try:
                    ...
                    speak_text(f"Error shutting down: {e}")
        ...
        if confirmation is not None:
            if "yes" in confirmation:
                ...
                try:
                    ...
                    speak_text(f"Error restarting: {e}")
            elif "no" in confirmation:
...
# Battery Status
    def get_battery_status(self):
        try:
            ...
            speak_text(f"Error getting battery status: {e}")
    ...
    def get_cpu_usage(self):
        try:
            ...
            speak_text(f"Error getting CPU usage: {e}")
    ...
    def check_internet(self):
        try:
            ...
            speak_text(f"Error checking internet: {e}")
    ...
    def get_current_time(self):
        try:
            ...
            speak_text(f"Error getting current time: {e}")
...
class WebFunctions:
    ...
    def web_search(self, query):
        try:
            ...
            speak_text(f"Error performing web search: {e}")
    ...
    def youtube_search(self, query):
        try:
            ...
            speak_text(f"Error performing YouTube search: {e}")
    ...
    def get_weather(self, city_name):
        try:
            ...
            speak_text(f"Error getting weather: {e}")
    ...
    def check_email(self):
        try:
            ...
            speak_text(f"Error opening email: {e}")
...
class UIHandler:
    ...
    def find_and_click_text(self, element_name):
        try:
            ...
            print(f"Error in find and click text: {e}")
            return False
